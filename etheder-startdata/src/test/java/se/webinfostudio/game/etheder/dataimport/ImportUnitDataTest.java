 ...
 *
 */
public class ImportUnitDataTest {
	...
	void beforeEach() throws DataImportException {
		...
		when(readExcel.getExcelRows(EXCEL_FILE_NAME, "Units")).thenReturn(asList(row, row, row).iterator());

		sut = new ImportUnitData(readExcel);
	}
